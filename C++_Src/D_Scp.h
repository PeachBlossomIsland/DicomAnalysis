 ...
 */
class DCMTK_DCMNET_EXPORT D_DcmSCP
{
...
public:
	 ...
	 *          </ul>
	 */
	virtual OFCondition listen(SharedBuf& srb);
...
protected:
	 ...
	 */
	virtual OFCondition waitForAssociationRQ(T_ASC_Network *network, SharedBuf& srb);
	 ...
	 */
	virtual OFCondition processAssociationRQ(SharedBuf &srb);
	 ...
	 */
	virtual void handleAssociation(SharedBuf& srb);
...
private:
	 ...
	 */
	D_DcmSCP(const D_DcmSCP &src);

	/** Private undefined assignment operator. Shall never be called.
	 *  @param src Source object
	 *  @return Reference to this
	 */
	D_DcmSCP &operator=(const D_DcmSCP &src);
};
