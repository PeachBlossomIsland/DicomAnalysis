#pragma once
#ifndef D_DcmStorageSCP_H
#define D_DcmStorageSCP_H

#include "dcmtk/config/osconfig.h"  /* make sure OS specific configuration is included first */

#include "dcmtk/ofstd/offname.h"    /* for OFFilenameCreator */
#include "D_Scp.h"       /* for base class D_DcmSCP */
  ...
  *---------------------*/
   ...
   */
class DCMTK_DCMNET_EXPORT D_DcmStorageSCP
	: public D_DcmSCP
{
...
private:
	...
	D_DcmStorageSCP(const D_DcmStorageSCP &);

	// private undefined assignment operator
	D_DcmStorageSCP &operator=(const D_DcmStorageSCP &);
};
